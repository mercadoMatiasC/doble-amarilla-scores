    ...
    return (
        <div id="match_panel" className="flex rounded bg-black/50 p-5 flex-col space-y-4">
            ...
            <div className="grid grid-cols-2 items-center gap-3 2xl:grid-cols-4">
                ...
                <DropdownSelect options={data.tournaments} name="tournament_id" value={formData.tournament_id} onChange={onChange} sideID="edition" />
            ...
            <div className="grid grid-cols-2 items-center gap-3 2xl:grid-cols-4">
                ...
                <DropdownSelect options={home_options} name="home_team_id" value={formData.home_team_id} onChange={onChange} sideID="id" />

                <label htmlFor="away_team_id">Visitante</label>
                <DropdownSelect options={away_options} name="away_team_id" value={formData.away_team_id} onChange={onChange} sideID="id" />
            </div>
