...
export function TournamentsIndex() {
  ...
  if (error) return <ErrorScreen error="Error cargando torneos." />;
    ...
    <>
      <PageAnimWrapper>
        <div className='rounded flex flex-col text-white bg-black/50 p-8 lg:justify-between w-[80%] space-y-3 lg:flex-row lg:w-1/2 lg:space-y-0 2xl:min-h-170'>
          <div className='space-y-3 lg:w-2/3 min-h-120 2xl:min-h-0'>
          ...
          <div className='flex flex-col gap-3 items-center justify-between lg:items-baseline lg:w-1/3 lg:flex-col'>
